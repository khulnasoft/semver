...
func incrementMajorVersion(vStr string) (string, error) {
	...
	if err != nil {
		return "", fmt.Errorf("Failed to convert major version %s: %w", parts[0], err)
	}
...
func incrementMinorVersion(vStr string) (string, error) {
	...
	if err != nil {
		return "", fmt.Errorf("Failed to convert minor version %s: %w", parts[1], err)
	}
...
func incrementPatchVersion(vStr string) (string, error) {
	...
	if err != nil {
		return "", fmt.Errorf("Failed to convert patch version %s: %w", parts[2], err)
	}
